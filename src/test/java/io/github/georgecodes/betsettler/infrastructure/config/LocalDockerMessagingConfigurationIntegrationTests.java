...
class LocalDockerMessagingConfigurationIntegrationTests {
  ...
  @Test
  void localDockerProfileSelectsRocketMqPublisherForDispatchAndReplay() {
    assertThat(betSettlementDispatchPort).isInstanceOf(RocketMqBetSettlementPublisher.class);
    assertThat(betSettlementReplayPort).isInstanceOf(RocketMqBetSettlementPublisher.class);
  }
